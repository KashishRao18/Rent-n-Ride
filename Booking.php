...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="car-details">
                        <div class="img rounded" style="background-image: url(Admin/CarImg/<?= $Image; ?>);"></div>
                ...
                <div class="col-sm">
                    <form method="post" id="OfferSubmit" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="offercode" id="offercode" placeholder="Offer code" size="15">
                        </div>
                        <div class="form-group">
                            <input type="submit"  name="ApplySubmit"  id="ApplySubmit" value="Apply Offerr" class="btn btn-secondary py-3 px-4">
                        </div>
                    </form>
                    ...
                    <script>
                        $(document).ready(function () {
                            $("#OfferSubmit").submit(function (event) {
                                ...
                                // Get form data
                                var code = document.getElementById("offercode").value;
                                // Submit form data using AJAX
                                $.ajax({
                                    type: "POST",
                                    url: "ajaxOffer.php",
                                    data: {offerCode: code, price: <?= $price; ?>},
                ...
                <div class="col-sm">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="col-md-12">
                            ...
                            <input type="submit" name="Cancel" id="BOOKCARNOW" value="Cancel" class="btn btn-secondary py-3 px-4" onclick="window.location.href='index.php';">
                            <!--<input type="submit" name="Cancel" id="BOOKCARNOW" value="Cancel" class="btn btn-secondary py-3 px-4" onclick="window.location.href='index.php';">-->
    ...
    if (isset($_POST['BOOKCARNOW'])) {
        ...
        if (mysqli_query($conn, $booking12)) {
            $newBookingId = mysqli_insert_id($conn);
            header("Location: Invoice.php?Booking_Id=$newBookingId");
        } else {
            echo "Booking failed.";
        }
        ...
        if ($booking1 > 0) {
            ...
            echo "<script>window.location.href='paymet.php?bookingId=" . urlencode($booking_id) . "'</script>";
        } else {
