        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2"><a href="#" class="logo">Rent<span>N</span>Ride</a></h2>
...
<!--                            </script>-->
<!--                            <div id="output"></div>-->
                            <li><span class="icon icon-map-marker"></span><span class="text" id="Cityname">Uka Tarsadia University, Bardoli</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 98542 78432</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@rentnride.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> by <a href="http://localhost/quickcarhire/index.php" target="_blank">RentNRide </a><i class="icon-heart color-danger" aria-hidden="true"></i>
