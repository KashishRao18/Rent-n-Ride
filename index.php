                ...
                <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
                    <div class="col-lg-8 ftco-animate">
                        <div class="text w-100 text-center mb-md-5 pb-md-5">
                            ...
                            <p style="font-size: 18px;">Make your drive easy with rent n ride .provides you the good and the luxurious car for your trip . make memories archieve your dream with our wheels</p>
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <form class="request-form ftco-animate bg-primary" action="car.php" method="post" enctype="multipart/form-data" style="height: 30rem;">
                                    ...
                                    <div class="form-group">
                                        <select id="mySelectCity" class="form-select" aria-label="Default select example" name="City" style="background-color: #1089ff;"  required>
                                            <?php
...
<!--                                    <script>-->
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="form-group ml-2">
                                            <label for="end-date" class="label">Return Date:</label>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="form-group ml-2">
                                            <label for="end-time" class="label">Return Time:</label>
                    ...
                    $(function () {
                        ...
                        startDateInput.datepicker({
                            ...
                            onSelect: function (selectedDate) {
                                ...
                                var minEndDate = new Date(startDate.getTime() + (1 * 60 * 60 * 1000)); //one day after start date
                                    ...
                                    <div class="item">
                                        <div class="car-wrap rounded ftco-animate" >
                                            ...
                                            <ul class="car__list">
                                                ...
                                                <li>
                                                    <i class="fa-solid fa-cart-flatbed-suitcase" style="color: #189cf4;"></i>&nbsp;&nbsp;
                                                    <span><?php echo $Laggage; ?> Laggage</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="services services-2 w-100 text-center">
                            ...
                            <div class="text w-100">
                                ...
                                <p>Identify your target audience, including engaged couples and event planners.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="services services-2 w-100 text-center">
                            ...
                            <div class="text w-100">
                                ...
                                <p>Add a new section or page in your system for city transfers.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="services services-2 w-100 text-center">
                            ...
                            <div class="text w-100">
                                ...
                                <p>Add a new section or page for airport transfer services in the system's user interface.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="services services-2 w-100 text-center">
                            ...
                            <div class="text w-100">
                                ...
                                <p>Conduct market research to identify popular tourist destinations and attractions in the city.</p>
                            </div>
                        </div>
                    </div>
                </div>
